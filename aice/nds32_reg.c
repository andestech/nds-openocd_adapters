...
//{
	/*
	{ .simple_mnemonic = "d0lo", .number = D0LO, .sr_index = MFUSR_G0(0, 0), .write_inst = MTUSR_G0(0, 0), },
	{ .simple_mnemonic = "d0hi", .number = D0HI, .sr_index = MFUSR_G0(0, 1), .write_inst = MTUSR_G0(0, 1), },
	{ .simple_mnemonic = "d1lo", .number = D1LO, .sr_index = MFUSR_G0(0, 2), .write_inst = MTUSR_G0(0, 2), },
	{ .simple_mnemonic = "d1hi", .number = D1HI, .sr_index = MFUSR_G0(0, 3), .write_inst = MTUSR_G0(0, 3), },
	{ .simple_mnemonic = "D0L24", .number = D0L24, .sr_index = AMFAR(0, 0x10), .write_inst = AMTAR(0, 0x10), },
	{ .simple_mnemonic = "D1L24", .number = D1L24, .sr_index = AMFAR(0, 0x11), .write_inst = AMTAR(0, 0x11), },
	{ .simple_mnemonic = "I0", .number = I0, .sr_index = AMFAR(0, 0x00), .write_inst = AMTAR(0, 0x00), },
	{ .simple_mnemonic = "I1", .number = I1, .sr_index = AMFAR(0, 0x01), .write_inst = AMTAR(0, 0x01), },
	{ .simple_mnemonic = "I2", .number = I2, .sr_index = AMFAR(0, 0x02), .write_inst = AMTAR(0, 0x02), },
	{ .simple_mnemonic = "I3", .number = I3, .sr_index = AMFAR(0, 0x03), .write_inst = AMTAR(0, 0x03), },
	{ .simple_mnemonic = "I4", .number = I4, .sr_index = AMFAR(0, 0x04), .write_inst = AMTAR(0, 0x04), },
	{ .simple_mnemonic = "I5", .number = I5, .sr_index = AMFAR(0, 0x05), .write_inst = AMTAR(0, 0x05), },
	{ .simple_mnemonic = "I6", .number = I6, .sr_index = AMFAR(0, 0x06), .write_inst = AMTAR(0, 0x06), },
	{ .simple_mnemonic = "I7", .number = I7, .sr_index = AMFAR(0, 0x07), .write_inst = AMTAR(0, 0x07), },
	{ .simple_mnemonic = "M1", .number = M1, .sr_index = AMFAR(0, 0x09), .write_inst = AMTAR(0, 0x09), },
	{ .simple_mnemonic = "M2", .number = M2, .sr_index = AMFAR(0, 0x0A), .write_inst = AMTAR(0, 0x0A), },
	{ .simple_mnemonic = "M3", .number = M3, .sr_index = AMFAR(0, 0x0B), .write_inst = AMTAR(0, 0x0B), },
	{ .simple_mnemonic = "M5", .number = M5, .sr_index = AMFAR(0, 0x0D), .write_inst = AMTAR(0, 0x0D), },
	{ .simple_mnemonic = "M6", .number = M6, .sr_index = AMFAR(0, 0x0E), .write_inst = AMTAR(0, 0x0E), },
	{ .simple_mnemonic = "M7", .number = M7, .sr_index = AMFAR(0, 0x0F), .write_inst = AMTAR(0, 0x0F), },
	{ .simple_mnemonic = "MOD", .number = MOD, .sr_index = AMFAR(0, 0x08), .write_inst = AMTAR(0, 0x08), },
	{ .simple_mnemonic = "LB", .number = LBE, .sr_index = AMFAR(0, 0x18), .write_inst = AMTAR(0, 0x18), },
	{ .simple_mnemonic = "LE", .number = LE, .sr_index = AMFAR(0, 0x19), .write_inst = AMTAR(0, 0x19), },
	{ .simple_mnemonic = "LC", .number = LC, .sr_index = AMFAR(0, 0x1A), .write_inst = AMTAR(0, 0x1A), },
	{ .simple_mnemonic = "ADM_VBASE", .number = ADM_VBASE, .sr_index = AMFAR(0, 0x1B), .write_inst = AMTAR(0, 0x1B), },
	{ .simple_mnemonic = "SHFT_CTL0", .number = SHFT_CTL0, .sr_index = AMFAR(0, 0x12), .write_inst = AMTAR(0, 0x12), },
	{ .simple_mnemonic = "SHFT_CTL1", .number = SHFT_CTL1, .sr_index = AMFAR(0, 0x13), .write_inst = AMTAR(0, 0x13), },
	{ .simple_mnemonic = "CB_CTL", .number = CB_CTL, .sr_index = AMFAR2(0, 0x1F), .write_inst = AMTAR2(0, 0x1F), },
	{ .simple_mnemonic = "CBB0", .number = CBB0, .sr_index = AMFAR2(0, 0x00), .write_inst = AMTAR2(0, 0x00), },
	{ .simple_mnemonic = "CBB1", .number = CBB1, .sr_index = AMFAR2(0, 0x01), .write_inst = AMTAR2(0, 0x01), },
	{ .simple_mnemonic = "CBB2", .number = CBB2, .sr_index = AMFAR2(0, 0x02), .write_inst = AMTAR2(0, 0x02), },
	{ .simple_mnemonic = "CBB3", .number = CBB3, .sr_index = AMFAR2(0, 0x03), .write_inst = AMTAR2(0, 0x03), },
	{ .simple_mnemonic = "CBE0", .number = CBE0, .sr_index = AMFAR2(0, 0x04), .write_inst = AMTAR2(0, 0x04), },
	{ .simple_mnemonic = "CBE1", .number = CBE1, .sr_index = AMFAR2(0, 0x05), .write_inst = AMTAR2(0, 0x05), },
	{ .simple_mnemonic = "CBE2", .number = CBE2, .sr_index = AMFAR2(0, 0x06), .write_inst = AMTAR2(0, 0x06), },
	{ .simple_mnemonic = "CBE3", .number = CBE3, .sr_index = AMFAR2(0, 0x07), .write_inst = AMTAR2(0, 0x07), },
	*/
	//{ .simple_mnemonic = "ifc_lp", .number = IFC_LP, .sr_index = MFUSR_G0(0, 29), .write_inst = MTUSR_G0(0, 29), },
	//{ .simple_mnemonic = "itb", .number = ITB, .sr_index = MFUSR_G0(0, 28), .write_inst = MTUSR_G0(0, 28), },
//};
	...
	while (nds32_ex_reg_values[i].reg_num != 0) {
		...
		if (ex_reg_value->reg_num == number) {
			...
			if (field_value == ex_reg_value->ex_value) {
				log_add (LOG_DEBUG, "It will generate exceptions as setting %d to %s",
