...
#define MFUSR_G0(a, b)			(0x42000020 | (a << 20) | (b << 15))	// Group 0
#define MTUSR_G0(a, b)			(0x42000021 | (a << 20) | (b << 15))	// Group 0
...
// big-endian break instructions
extern const int ANDES_BREAK_16;
extern const int ANDES_BREAK_32;
